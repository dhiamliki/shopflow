  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'reviews',
        loadComponent: () =>
          import('./features/my-reviews/my-reviews.page').then((m) => m.MyReviewsPageComponent)
      },
      {
        path: 'settings',
        loadComponent: () =>
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'listings',
        loadComponent: () =>
          import('./features/seller-listings/seller-listings.page').then(
            (m) => m.SellerListingsPageComponent
          )
      },
      {
        path: 'create-listing',
      ...
      },
      {
        path: 'orders',
        loadComponent: () =>
          import('./features/seller-orders/seller-orders.page').then((m) => m.SellerOrdersPageComponent)
      },
      {
        path: 'analytics',
        loadComponent: () =>
          import('./features/seller-analytics/seller-analytics.page').then(
            (m) => m.SellerAnalyticsPageComponent
          )
      },
      {
        path: 'settings',
        loadComponent: () =>
          import('./features/seller-settings/seller-settings.page').then(
            (m) => m.SellerSettingsPageComponent
          )
      }
    ]
  },
